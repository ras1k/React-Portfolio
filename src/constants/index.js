...
const testimonials = [{
        testimonial: "I thought it was impossible to make a website as beautiful as our product, but Rasik proved me wrong.",
        name: "Moammer Enan",
    ...
    {
        testimonial: "I've never met a web developer who truly cares about their clients' success like Rasik does.",
    ...
    {
        testimonial: "After Rasik optimized our website, our traffic increased by 50%. We can't thank him enough!",
...
const projects = [{
    ...
    },
    {
        ...
        description: "A comprehensive toy marketplace marketplace that allows users to create their product list & showcase it to users.",
        tags: [{
                name: "react",
                color: "blue-text-gradient",
            },
    ...
    // },
    {
        ...
        description: "A simple yet beautifully designed portfolio website using modern technologies for web developers ",
        tags: [{
                name: "react",
                color: "blue-text-gradient",
            },
